...
function obtenerCadena() { //Con esta funcion obtenemos y retornamos el mensaje escrito por nuestro usuario
    let cadenaUsuario = document.getElementById("contenido-entrada__textarea").value; //Obtenemos el valor ingresado por nuestro usuario
    return cadenaUsuario;
}

function borrarClases() {
    document.getElementById("contenido-salida__img").classList.remove("contenido-salida__img--activado")
    document.getElementById("contenido-salida__titulo").classList.remove("contenido-salida__titulo--activado")
    document.getElementById("contenido-salida__texto").classList.remove("contenido-salida__texto--activado")
}
...
function mensajeNoEncontrado(){ //Funcion utilizada para decirle a nuestro usuario que no existe ningun mensaje para encriptar
    borrarClases()
    document.querySelector("#contenido-salida__img").setAttribute("src","imagenes/animal-penguin.png")
    document.getElementById("contenido-salida__titulo").innerHTML="Ningun mensaje fue encontrado" //Cambiamos el mensaje en nuestro <h2>
    document.getElementById("contenido-salida__texto").innerHTML="Ingresa el mensaje que desees encriptar o desencriptar" ////Cambiamos el mensaje en nuestro <p>
}
...
function mensajeLetraMayuscula(){ //Funcion utilizada para decirle a nuestro usuario que hay una letra mayuscula en su mensaje
    borrarClases()
    document.querySelector("#contenido-salida__img").setAttribute("src","imagenes/pajaro-enojado.png")
    document.getElementById("contenido-salida__titulo").innerHTML="Hay mayusculas en tu mensaje"
    document.getElementById("contenido-salida__texto").innerHTML="Recuerda que no esta permitido el uso de mayusculas en tu mensaje"
}

function mensajeAcentos(){ //Funcion utilizada para decirle a nuestro usuario que hay un acento en su mensaje
    borrarClases()
    document.querySelector("#contenido-salida__img").setAttribute("src","imagenes/pajaro-enojado.png")
    document.getElementById("contenido-salida__titulo").innerHTML="Hay acentos en tu mensaje"
    document.getElementById("contenido-salida__texto").innerHTML="Recuerda que no esta permitido el uso de acentos en tu mensaje"
}
...
function mostrarResultado(cadena) { //Funcion usada para mostrar el resultado al usuario
    document.getElementById("contenido-salida__img").classList.add("contenido-salida__img--activado")
    document.getElementById("contenido-salida__titulo").classList.add("contenido-salida__titulo--activado")
    document.getElementById("contenido-salida__texto").classList.add("contenido-salida__texto--activado")
